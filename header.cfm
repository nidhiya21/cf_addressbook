<nav class="navbar navbar-expand-xl navbar-dark bg-dark">
	...
	<div id="navbarCollapse" class="collapse navbar-collapse justify-content-start">		
		<div class="navbar-nav ml-auto">
			...
			<cfelse>
				<a href="./logout.cfm" class="nav-item nav-link"><i class="fa fa-solid fa-arrow-left-to-bracket"></i></a><span class="nav-text"><a href="./logout.cfm" class="nav-links">Logout</a></span> 
			</cfif>
		</div>
	</div>
</nav>
