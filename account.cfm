			...
			<div class="table-responsives">
                ...
                <div class="pfl-block profile-badge">
                    <div class="avatar profile-pic">
						...
						<cfinvoke component="components.contact" method="getUserImage" returnvariable="getUsrImage"> 
							<cfinvokeargument name="userID"  value = #Session.userID# /> 
						</cfinvoke> 
						<form  method="post" name="userImgUpload" id="userImgUpload">
							<cfif getUsrImage.userImage EQ ''>
                                 <input type="image" id="profile-image1" class="no-img" src="./images/user-icon.jpg" width="50%"/>
                            <cfelse>  
                                <input type="image" class="no-img" id="profile-image1" src="userimage/#getUsrImage.userImage#" width="86%" alt="...">                                     
                            </cfif>
							<input id="userImg" name="userImg" class="hidden" type="file" onchange="previewFile(#userID#)" >
						</form>
					</div>
