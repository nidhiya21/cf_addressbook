		...
		<cfoutput>
			...
			<div class="container-xl">
				<div class="table-responsives">
					...
					<cfelse>
						<div class="pfl-block profile-badge new-register">
					</cfif>
					...
					<div class="modal-content">	
						...
						<form action="" method="post" name="contact" id="contact" enctype="multipart/form-data">
							<div class="modal-header">						
								<div id="contact-head"><h4 class="modal-title mod-title">CREATE CONTACT</h4></div>	
							</div>
							<cfif isDefined("errors")> 
								<div class="error">#variables.errors#</div>
							</cfif>
