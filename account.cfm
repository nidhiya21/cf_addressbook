					...
					<table class="table table-striped table-hover">
						...
						<tbody>
							<tr>
								...
								<td>7894561235</td>
								<td>
									<a href="" class="edit modal-trigger-edit"   data-toggle="modal" data-target=".editEmployeeModal"><span class="modal-txt">EDIT</span></a>
								</td>
								<td>
									<a href="" class="delete modal-trigger"   data-toggle="modal" data-target=".deleteEmployeeModal"><span class="modal-txt">DELETE</span></a>
								</td>
								<td>
									<a href="" class="view modal-trigger"   data-toggle="modal" data-target=".deleteEmployeeModal"><span class="modal-txt">VIEW</span></a>
								</td>
							</tr>
						</tbody>
					</table>					
							...
							<div class="row">
								...
								<div class="col-sm-6">
									<div class="form-group">
										...
										<hr>
										<input type="text" class="form-control" id="street" placeholder="Your Street"  required>
									</div>
								</div>
							</div> 
							<div class="row">
								...
								<div class="col-sm-6">
									<div class="form-group">
										...
										<hr>
										<input type="text" class="form-control" id="phoneNumber" placeholder="Your Phone"  required>
									</div>
								</div>
							</div> 
							<div class="row">
								<div class="col-sm-6">
									<div class="form-group ">
										...
										<hr>
										<input type="pincode" class="form-control" id="pincode" placeholder="Your Pincode">
									</div>
								</div>
							</div>         				
						</div>						
