...
<html lang="en">
	...
	<body>
				...
				<div class="modal-content">	
					...
					<form action="" method="post" name="contact" enctype="multipart/form-data">
							...
							<div class="row">
								<div class="col-sm-8">
									<div class="form-group">
										...
										<input type="file" name="attachment" accept=".jpg,.jpeg,.png" id="attachment">
									</div>
								</div>
							</div>   
							...
							<div class="row">
								...
								<div class="col-sm-6">
									<div class="form-group">
										...
										<hr>
										<input type="text" class="form-control" name="street" id="street" placeholder="Your Street"  required>
									</div>
								</div>
							</div> 
							<div class="row">
								...
								<div class="col-sm-6">
									<div class="form-group">
										...
										<hr>
										<input type="text" class="form-control" id="phoneNumber" name="phoneNumber" placeholder="Your Phone"  required>
									</div>
								</div>
							</div> 
							<div class="row">
						...
						<div class="modal-footer">
							...
							<input type="submit" name="formContactSubmit" class="btn btn-success formContactSubmit" value="Add">
						</div>
					</form>
				</div>
			</div>
		...
		<cfoutput query="result" >
		<div id="editEmployeeModal_#result.contactID#" class="modal fade editEmployeeModal_#result.contactID#">
			<div class="modal-dialog">
				<div class="modal-content">	
					<cfparam name="form.title" default=""> 
                    <cfparam name="form.firstName" default="">   
					...
					<cfparam name="form.phoneNumber" default=""> 
					<cfparam name="form.pincode" default=""> 
					<form action="" method="post" name="contactUpdate" enctype="multipart/form-data">
						<div class="modal-header">						
							<div id="contact-head"><h4 class="modal-title">EDIT CONTACT</h4></div>

						</div>
						<div class="modal-body">
							<input type="hidden" id="contactID" name="contactID" value= <cfoutput>#result.contactID#</cfoutput> />
							<input type="hidden" id="userID" name="userID" value= <cfoutput>#Session.userID#</cfoutput> />
							<div class="main-head">Personal Contact</div>
                    		<hr class="new1">					
							<div class="row">
								<div class="col-sm-4">
									...
									<hr class="label-txt">
									<select class="form-control" name= "title" id="title">
										<option value="Mr" <cfif result.title eq "Mr" >selected</cfif>>Mr</option>
										<option value="Ms" <cfif result.title eq "Ms" >selected</cfif>>Ms</option>
										<option value="Mrs" <cfif result.title eq "Mrs" >selected</cfif>>Mrs</option>
									</select>
									</div>
								</div>
								<div class="col-sm-4">
									<div class="form-group ">
										<label for="firstName">First Name<span class="required"></span></label>
										<hr class="label-txt">
										<input type="text" class="form-control" id="firstName" value=#result.firstName# placeholder="Your First Name" required>
									</div>
								</div>
								<div class="col-sm-4">
									<div class="form-group">
										<label for="lastName">Last Name<span class="required"></span></label>
										<hr>
										<input type="text" class="form-control" id="lastName" value=#result.lastName# placeholder="Your Last Name"  required>
									</div>
								</div>
							</div>
							<div class="row">
								<div class="col-sm-6">
									<div class="form-group ">
										<label for="gender">Gender<span class="required"></span></label>
										<select class="form-control" id="gender" name="gender">
											<option <cfif result.gender eq "Male" >selected</cfif>value="Male">Male</option>
											<option <cfif result.gender eq "Female" >selected</cfif>value="Female">Female</option>
										</select>
									</div>
								</div>
								<div class="col-sm-6">
									<div class="form-group">
										<label for="dob">Date of Birth<span class="required"></span></label>
										<input type="date" name="dob" id="dob" value=#result.dob#  class="form-control" />
									</div>
								</div>
							</div>
							<div class="row">
							...
							<div class="row">
								<div class="col-sm-6">
									<div class="form-group ">
										<label for="address">Address<span class="required"></span></label>
										<hr>
										<input type="text" class="form-control" value=#result.address#  name="address" id="address" placeholder="Your Address" required>
									</div>
								</div>
								<div class="col-sm-6">
									<div class="form-group">
										<label for="street">Street<span class="required"></span></label>
										<hr>
										<input type="text" class="form-control" value=#result.street#   name="street" id="street" placeholder="Your Street"  required>
									</div>
								</div>
							</div> 
							<div class="row">
								<div class="col-sm-6">
									<div class="form-group ">
										<label for="email">Email<span class="required"></span></label>
										<hr>
										<input type="email" class="form-control" name="email" id="email"  value=#result.email#  placeholder="Your Email" required>
									</div>
								</div>
								<div class="col-sm-6">
									<div class="form-group">
										<label for="street">Phone Number<span class="required"></span></label>
										<hr>
										<input type="text" class="form-control" id="phoneNumber" value=#result.phoneNumber# name="phoneNumber" placeholder="Your Phone"  required>
									</div>
								</div>
							</div> 
							<div class="row">
								<div class="col-sm-6">
									<div class="form-group ">
										<label for="text">Pincode</label>
										<hr>
										<input type="pincode" class="form-control" id="pincode" value=#result.pincode#  name="pincode" placeholder="Your Pincode">
									</div>
								</div>
							</div>         				
						</div>						
						<div class="modal-footer">
							<input type="button" class="btn btn-default" data-dismiss="modal" value="Cancel">
							<input type="submit" name="formEditContactSubmit" class="btn btn-success formEditContactSubmit" value="Add">
						</div>
					</form>
				</div>
			</div>
